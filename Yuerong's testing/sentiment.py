...
data=pd.read_csv('/Users/hu/Desktop/BPO2019fall/PR/sentiment_analysis_vaderSentiment/cleaned_data/billboard_lyrics_2001-2015.csv')
sentSet=data['Lyrics'].tolist()
...
output=DataFrame(c)
print(output.info())
output.to_csv("LyricsSentimentScores.csv")
